    ...
    <header className="sticky top-0 z-999 flex w-full  bg-[#fbfbfb] backdrop-filter backdrop-blur-sm">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        Dashboard
            ...
            <h3 className="ml-4 text-sm font-semibold text-black">
           Payments Updates
            </h3>
        </div>
        ...
        <div
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full bg-[#8061d9] text-white"
      >
        <img src="/public/images/icon/icon-header-setting.svg"/>
      </div>
            {/* <!-- Dark Mode Toggler --> */}
            {/* <DarkModeSwitcher /> */}
            {/* <!-- Dark Mode Toggler --> */}
